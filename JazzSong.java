...
public class JazzSong extends Song{
	private ArrayList<String> Drumline = new ArrayList<String>(Arrays.asList("A5", "B5", "C5", "D5", "E5", "F5", "G5"));
	public JazzSong(int howLong, int mostCommonColour, int averageColour, ArrayList<String> theChords) {
