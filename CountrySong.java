...
public class CountrySong extends Song{
	private ArrayList<String> Drumline = new ArrayList<String>(Arrays.asList("A5", "", "D5", "G5"));
	public CountrySong(int howLong, int mostCommonColour, int averageColour, ArrayList<String> theChords) {
